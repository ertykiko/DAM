...
class PageWalkConfirm extends StatefulWidget {
  const PageWalkConfirm({
    Key? key,
  }) : super(key: key);
...
class _State extends AuthState<PageWalkConfirm>
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Text(r'''Elige tu morada de paseo''',
                                  style: GoogleFonts.poppins(
                                    textStyle: TextStyle(
                                      color: const Color(0xFFFFFFFF),
                                      fontWeight: FontWeight.w500,
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Text(r'''Elige el tiempo de paseo''',
                                  style: GoogleFonts.poppins(
                                    textStyle: TextStyle(
                                      color: const Color(0xFFFFFFFF),
                                      fontWeight: FontWeight.w500,
                      ...
                      child: GestureDetector(
                          onTap: () async {
                            await Navigator.push<void>(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PageSelectAssistant(),
                              ),
                            );
                          },
                          child: Container(
